...
* Käyttäjä pystyy valitsemaan ilmoitukselle yhden tai useamman luokittelun (esim. kenkien merkki, kenkien kunto, vastaanottotapa (meetup tai vain lähetys)).
* Käyttäjä pystyy tarjoamaan myytävänä olevalle tuotteelle oman hinnan.
